export default {
  common: {
    ...
    menu: {
      ...
      create_from_mnemonic: 'Create With Mnemonic',
  ...
  create_token: {
    ...
    name: 'Token Name',
    symbol: 'Token Symbol',
    decimal: 'Decimals (It\'s recommended to set decimals to 8 in SIRX)',
  ...
  restore_ledger: {
    ...
    usage: 'Please ensure your firmware and app are the newest version. Plugin your Ledger, open Sirius APP, and then click the "CONNECT" button below try to connect.',
    download: 'No Sirius APP? Please install it follow this https://www.ledgerwallet.com/apps/manager',
    connect: 'CONNECT',
  },
  view: {
