<template>
  <v-card>
    ...
    <v-card-text>
      ...
      <v-layout v-if="wallet.info.erc20.length > 0">
        <v-flex xs3>
          <v-subheader>
            ERC20
          </v-subheader>
        ...
        <v-flex xs7>
          <v-card flat tile :color="'grey darken-'+(i%2+1)" style="border-bottom: 2px solid #000;padding: 15px 10px;" v-for="(token, i) in wallet.info.erc20" :key="i">
            <v-layout>
